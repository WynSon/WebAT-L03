...
if (!empty($_POST['save'])){
    ...
    // If don't have erro -> insert  new studen
    
    if (!$errors){
            register($user['username'], $user['password'], $data['fullname'], $data['email'], $data['phone'], $data['address'], 1, 'edit'); ?>
            <script>alert('The edit request is sent to admin, it need to approve before change!');
            window.location='./profile.php?username=<?php echo $data['username']; ?>';</script> <?php
    }
}
?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="profile-head">
                                    ...
                                    <h5>
                                    <?php if($data['role'] == 3) echo "Customer"; else echo "Staff";  ?>
                                    </h5>
